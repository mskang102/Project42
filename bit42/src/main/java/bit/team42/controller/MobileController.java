...
public class MobileController {
	 ...
	 @RequestMapping(value = "/hanza/{grade},{page}", method = RequestMethod.GET)
	   public String HanzaHome(Model model,HanzaVO vo,MobileCriteria cri,HttpServletRequest req,String userid,String token){
	   ...
	   public ResponseEntity<String> loginout(HttpServletRequest request, HttpSession session, HttpServletResponse response){
		   try {
		 ...
		 @RequestMapping(value = "/home", method = RequestMethod.GET)
		   public String mobileHome(Model model,String userid,String token,HttpSession session,HttpServletResponse response){
			 try {
				...
				if(vo.getToken().equals(token)){
					...
					System.out.println(vo.getChoice());
		  ...
		  @RequestMapping(value = "gradedepth/{grade},{page}", method = RequestMethod.GET)
		   public String gradedepth(Model model,HanzaVO vo,@PathVariable("page")int page,Criteria cri,HttpServletRequest req){
		      ...
		      System.out.println("--------childVO--------"+child);
		      return "mobile/grade";
		   }
			 ...
			 @RequestMapping(value = "study/{grade},{page}", method = RequestMethod.GET)
			  ...
			  @RequestMapping(value = "/userread", method = RequestMethod.GET)
				public String read(Model model,@ModelAttribute("cri")SearchCriteria cri,HttpServletRequest req) throws Exception{
					HttpSession temp = req.getSession();
					MemberVO user = (MemberVO)temp.getAttribute("login");
					String userid = user.getUserid();
