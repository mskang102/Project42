...
public class LoginController {
   ...
   public void loginPost(LoginDTO dto, HttpSession session, Model model)throws Exception{
      ...
      System.out.println("vo choice::::::::::::::::::"+vo.getChoice());
      int cno = vo.getChoice();
      dto.setCno(cno);
      
      ChildVO cvo = service.clogin(dto);
      System.out.println("vo:::::::::::"+vo);
      System.out.println("loginPost dto::::::::::::::::::::::"+dto);
      ...
      System.out.println("session cvo :::::::::::::::"+cvo);
      ...
      if(dto.isUserCookie()){
         ...
         System.out.println("isuserCookie::::::::::::::::::::"+dto.isUserCookie());
